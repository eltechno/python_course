...
for key in people: #key guarda la info de dictionary people
    print ("ID:", key) #despliega el valor de key
    for secondaryKey in people[key]: #  # segunda key guarda mas valos de llaves
        print (secondaryKey, ":", people[key][secondaryKey]) # despliega valores del dic basados en key y second key